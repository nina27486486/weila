...
class PluginAdapter extends TypeAdapter<Plugin> {
  ...
  void write(BinaryWriter writer, Plugin obj) {
    writer
      ..writeByte(13)
      ..writeByte(0)..write(obj.api)
      ..writeByte(1)..write(obj.name)
      ..writeByte(2)..write(obj.version)
      ..writeByte(3)..write(obj.baseUrl)
      ..writeByte(4)..write(obj.searchURL)
      ..writeByte(5)..write(obj.searchList)
      ..writeByte(6)..write(obj.searchName)
      ..writeByte(7)..write(obj.searchResult)
      ..writeByte(8)..write(obj.chapterRoads)
      ..writeByte(9)..write(obj.chapterResult)
      ..writeByte(10)..write(obj.userAgent)
      ..writeByte(11)..write(obj.referer)
      ..writeByte(12)..write(obj.enabled);
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is PluginAdapter && runtimeType == other.runtimeType && typeId == other.typeId;
}
