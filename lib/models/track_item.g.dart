...
class TrackItemAdapter extends TypeAdapter<TrackItem> {
  ...
  TrackItem read(BinaryReader reader) {
    ...
    return TrackItem(
      ...
      totalEpisodes: fields[5] as int,
      watchedEpisodes: fields[6] as int,
  ...
  void write(BinaryWriter writer, TrackItem obj) {
    writer
      ...
      ..writeByte(6)..write(obj.watchedEpisodes)
      ..writeByte(7)..write(obj.trackedAt)
      ..writeByte(8)..write(obj.lastUpdated);
  }
  ...
  bool operator ==(Object other) =>
      ...
      other is TrackItemAdapter && runtimeType == other.runtimeType && typeId == other.typeId;
}
